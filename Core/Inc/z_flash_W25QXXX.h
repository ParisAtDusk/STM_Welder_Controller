...
// W25X40
#define EXT_FLASH_PAGE_SIZE 0x0100	   // 256 bytes per page
#define EXT_FLASH_SECTOR_SIZE 0x1000   // 4 KB per sector
#define EXT_FLASH_BLOCK_SIZE 0x010000  // 64 KB per block
#define EXT_FLASH_SIZE 0x080000		   // 512 KB total size (4 Mbits)
#define EXT_FLASH_PAGE_NUM 0x0800	   // 2048 pages
#define EXT_FLASH_SECTOR_NUM 0x0080	   // 128 sectors
#define EXT_FLASH_BLOCK_NUM 0x0008	   // 8 blocks
